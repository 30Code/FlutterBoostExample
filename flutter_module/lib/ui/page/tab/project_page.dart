...
import 'package:flutter_module/flutter/dropdown.dart';
...
import 'package:flutter_module/utils/status_bar_utils.dart';
import 'package:flutter_module/view_model/project_model.dart';
      ...
      child: Theme(
        ...
        child: DropdownButtonHideUnderline(
          ...
          items: List.generate(model.list.length, (index) {
            ...
            var subhead = theme.primaryTextTheme.titleMedium;
